...
namespace Serial_Deserial
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FileStream f = new FileStream(@"D:\Saber\SaberTest.txt", FileMode.OpenOrCreate);
            listRand.Serialize(f);
            f.Close();


            FileStream fRead = File.OpenRead(@"D:\Saber\SaberTest.txt");
            ListRand list = new ListRand();
            list.Deserialize(fRead);
        }
    }
}